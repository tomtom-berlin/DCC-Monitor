      ...
      switch (Msg->Data[0] & B00001100) {
        ...
        case B00001000:  // Bit Write
          ...
          if (Msg->Data[2] & B00010000) {
            ...
            SerialBT.print(Msg->Data[2] & B00000111);
            SerialBT.print(" = ");
            SerialBT.print((Msg->Data[2] & B00001000) >> 3);
            print_spaces(36);
          } else {
        ...
        switch (command) {
          ...
          case 8:  // B1000 ==> Bit-Gefummel !
            ...
            if (Msg->Data[pktByteCount - 2] & B00010000) {
              SerialBT.print("Schreibe Bit #");
              SerialBT.print(Msg->Data[pktByteCount - 2] & B00000111);
              SerialBT.print(" = ");
              SerialBT.print((Msg->Data[pktByteCount - 2] & B00001000) >> 3);
              print_spaces(36);
            } else {
              SerialBT.print("Lese    Bit #");
              SerialBT.print(Msg->Data[2] & B00000111);
      ...
      switch (instructionType) {
        ...
        case 1:
          ...
          else if (Befehls_Byte == B00111110)  // Speed Restriction
          {
            ...
            SerialBT.print(Msg->Data[pktByteCount - 1]) & B01111111;
            print_spaces(22);
          }
        ...
        case 6:  // 110x-xxxx Eigenschaften-Erweiterungs-Befehle
          ...
          switch (Befehls_Byte & B00011111) {
            ...
            case 0:  // Binary State Control Instruction long form
              ...
              SerialBT.print(256 * Msg->Data[pktByteCount - 1] + (Msg->Data[pktByteCount - 2] & B01111111));
              if bitRead (Msg->Data[pktByteCount - 2], 7) SerialBT.print(" On ");
              else SerialBT.print(" Off ");
              break;
            //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
